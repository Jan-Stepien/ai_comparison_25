...
import 'package:zed/movies/list/presentation/widgets/movie_list_results_list.dart';
...
class MovieListResultsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hasReachedMax = context.select((MovieListBloc bloc) => bloc.state.hasReachedMax);
