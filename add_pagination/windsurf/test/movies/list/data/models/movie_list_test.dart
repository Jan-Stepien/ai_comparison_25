  ...
  group('MovieList', () {
    test('should create MovieList from JSON', () {
      final json = {
        'total_results': 100,
        'results': [
          {'title': 'Test Movie 1', 'vote_average': 8.5, 'id': 123},
          {'title': 'Test Movie 2', 'vote_average': 7.5, 'id': 456},
        ],
      };
      ...
      expect(movieList.totalPages, equals(10));
      expect(movieList.page, equals(1));
    ...
    test('should convert MovieList to JSON', () {
      final movieList = MovieList(
        ...
        page: 1,
        results: [
          MovieListItem(title: 'Test Movie 1', voteAverage: 8.5, id: 123),
          MovieListItem(title: 'Test Movie 2', voteAverage: 7.5, id: 456),
        ],
      );
