...
import 'package:windsurf/movies/list/presentation/widgets/movie_list_results_list.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: switch (status) {
        ...
        LoadingStatus.loadingMore => MovieListResultsList(movieList: movieList),
