...
import 'package:copilot/movies/details/domain/models/movie_details.dart';
import 'package:copilot/movies/details/presentation/state/movie_details_bloc/movie_details_event.dart';
import 'package:copilot/movies/details/presentation/state/movie_details_bloc/movie_details_state.dart';
...
void main() {
  ...
  group('MovieDetailsPage', () {
    ...
    setUp(() {
      ...
      ).thenAnswer((_) => Stream<MovieDetails?>.value(null));
    });
    group('renders', () {
      ...
      testWidgets('error message if movieId is null', (
        ...
        await tester.pumpWidget(
          AppProvider(child: const MovieDetailsPage(movieId: null)),
        );
