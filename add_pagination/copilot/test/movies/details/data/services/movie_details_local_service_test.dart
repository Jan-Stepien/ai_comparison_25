...
void main() {
  ...
  group('saveMovieDetails', () {
    test('saves movie details to storage and emits to stream', () async {
      ...
      verify(() => mockStorage.setString('k_movie_details', any())).called(1);
  ...
  group('clear', () {
    test(
      'removes movie details from storage and emits null to stream',
      () async {
  ...
  group('initialization', () {
    ...
    test(
      'returns movie details and emits them when local storage is valid',
      () {
        when(
