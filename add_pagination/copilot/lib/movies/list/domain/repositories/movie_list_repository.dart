...
class MovieListRepository {
  ...
  Stream<PaginatedResults> get paginatedStream => _localService.paginatedStream;
  ...
  Future<PaginatedResults> getPage(int page, {int pageSize = 10}) async {
    return _localService.getPage(page, pageSize: pageSize);
  }
}
